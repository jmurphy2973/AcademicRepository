...
public:
	...
	** will be required for */
	...
	int get_startStrength(){ return startStrength; };
	void set_Strength(int setStr){ valCurStrength = setStr; };

	/* New function to randomly retore % health of Winner*/
	virtual void restore_Strength(); /* Virtual Due to Handling requirement of HP */
